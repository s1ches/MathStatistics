...
class DataModel:
    ...
    def __str__(self):
        return (f"Samples:\n"
                ...
                f"Y sample:\n {self.y_sample}\n\n"
                f"Means:\n"
                f"X mean: {self.x_mean.__round__(3)}\n"
                f"Y mean: {self.y_mean.__round__(3)}\n\n"
                f"Mean Standard Deviation:\n"
                f"X standard deviation: {self.x_std.__round__(3)}\n"
                f"Y standard deviation: {self.y_std.__round__(3)}\n\n"
                f"Covariance: {self.covariance.__round__(3)}\n\n"
                f"Predictions:\n"
